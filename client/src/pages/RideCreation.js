...
const RideCreation = () => {
    ...
    useEffect(() => {
        ...
        const fetchDriverDetails = async () => {
            try {
                ...
                const response = await axios.get(`http://192.168.100.175:5000/api/auth/users/${userId}`); // Endpoint to fetch driver details
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await axios.post(
                'http://192.168.100.175:5000/api/rides/create',
                ridePayload,
                {
                    headers: {
